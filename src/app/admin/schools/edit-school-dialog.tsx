...
export function EditSchoolDialog({ school, trigger }: EditSchoolDialogProps) {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-xs animate-in fade-in duration-200 font-jost text-left">
          <div className="bg-white w-full max-w-lg rounded-2xl shadow-2xl border border-slate-200 overflow-hidden animate-in zoom-in-95 duration-200">
            <div className="flex justify-between items-center p-6 border-b border-slate-100 bg-slate-50/50">
              <div>
                <h2 className="text-lg font-bold text-slate-900 font-heading">Edit School / Faculty</h2>
                <p className="text-xs text-slate-500 mt-0.5">Update department details or descriptions.</p>
              </div>
            ...
            <form action={action}>
              <div className="p-6 space-y-4 max-h-[70vh] overflow-y-auto">
                ...
                <div className="space-y-1.5">
                  <Label htmlFor="name" className="text-xs font-bold text-slate-700">School Name *</Label>
                  <Input 
                    id="name" 
                    name="name" 
                ...
                <div className="space-y-1.5">
                  ...
                  <textarea 
                    ...
                    rows={4}
                    placeholder="e.g. Faculty of Business and Advanced Technology"
