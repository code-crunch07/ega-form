  ...
  return (
    <div className="flex flex-col sm:flex-row gap-3 mb-6 font-jost">
      <div className="relative flex-1">
        ...
        <Input 
          placeholder="Search campus name, city, or country..." 
          value={search}
      ...
      <div className="flex flex-wrap sm:flex-nowrap gap-2.5 items-center">
        ...
        >
          <SelectTrigger className="w-[170px] h-11 bg-white border-slate-200 rounded-xl text-slate-700 font-medium text-xs shadow-2xs focus:border-[#252D65]">
