...
export function TemplatesFilters() {
  ...
  const hasActiveFilters = !!(currentSearch || currentStatus || currentChannel);
  ...
  return (
    <div className="flex flex-col sm:flex-row gap-3 mb-6 font-jost">
      <div className="relative flex-1">
        ...
        <Input 
          placeholder="Search template name, trigger, channel, or subject..." 
          value={search}
      ...
      <div className="flex flex-wrap sm:flex-nowrap gap-2.5 items-center">
        ...
        <Select
          ...
          onValueChange={(val: string | null) => createQueryString("channel", val || "all")}
        >
