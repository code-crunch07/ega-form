...
export function FeesFilters() {
  ...
  const hasActiveFilters = !!(currentSearch || currentStatus || currentType);
  ...
  return (
    <div className="flex flex-col sm:flex-row gap-3 mb-6 font-jost">
      <div className="relative flex-1">
        ...
        <Input 
          placeholder="Search fee name or applicable audience..." 
          value={search}
      ...
      <div className="flex flex-wrap sm:flex-nowrap gap-2.5 items-center">
        ...
        <Select
          ...
          onValueChange={(val: string | null) => createQueryString("type", val || "all")}
        >
          ...
          <SelectContent className="rounded-xl border-slate-200 bg-white shadow-xl">
            ...
            <SelectItem value="Program Specific">Program Specific</SelectItem>
          </SelectContent>
        </Select>
