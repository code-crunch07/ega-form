...
const INVOICES = [
  { id: "inv_1", number: "INV-2026-001", applicant: "John Smith", amount: 1500.00, issueDate: "2026-06-15", dueDate: "2026-07-15", status: "Unpaid", type: "Tuition Deposit" },
  { id: "inv_2", number: "INV-2026-002", applicant: "Emily Chen", amount: 50.00, issueDate: "2026-07-01", dueDate: "2026-07-15", status: "Paid", type: "Application Fee" },
  { id: "inv_3", number: "INV-2026-003", applicant: "Michael Johnson", amount: 3500.00, issueDate: "2026-05-20", dueDate: "2026-06-20", status: "Overdue", type: "Semester Tuition" },
];
