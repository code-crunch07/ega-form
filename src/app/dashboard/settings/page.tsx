  ...
  return (
    <div className="animate-in fade-in space-y-8 pb-10 duration-500">
      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
        ...
        <section className="overflow-hidden rounded-2xl border border-neutral-200/80 bg-white shadow-sm">
          <div className="flex items-center gap-2 border-b border-neutral-100 bg-neutral-50/50 px-6 py-4">
            <Bell size={18} className="text-[#2C315E]" />
            ...
            {NOTIFICATION_PREFS.map((pref) => (
              ...
              >
                <input
                  ...
                  className="mt-1 h-4 w-4 rounded accent-[#2C315E]"
                />
                <div>
        ...
        <section className="overflow-hidden rounded-2xl border border-neutral-200/80 bg-white shadow-sm">
          <div className="flex items-center gap-2 border-b border-neutral-100 bg-neutral-50/50 px-6 py-4">
            <Globe size={18} className="text-[#2C315E]" />
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="space-y-2">
              ...
              <select className="h-11 w-full rounded-xl border border-neutral-200 bg-neutral-50/80 px-3 text-sm focus:border-[#2C315E]/40 focus:outline-none focus:ring-2 focus:ring-[#2C315E]/10">
        ...
        <section className="overflow-hidden rounded-2xl border border-neutral-200/80 bg-white shadow-sm lg:col-span-2">
          <div className="flex items-center gap-2 border-b border-neutral-100 bg-neutral-50/50 px-6 py-4">
            <Shield size={18} className="text-[#2C315E]" />
      ...
      <div className="flex items-center justify-end gap-3">
        ...
        <Button
          onClick={handleSave}
          className="h-11 rounded-xl bg-[#2C315E] px-8 hover:bg-[#232752]"
        >
          Save Changes
        </Button>
      </div>
