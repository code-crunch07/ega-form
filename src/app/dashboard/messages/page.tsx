      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
        <div className="flex flex-col overflow-hidden rounded-2xl border border-neutral-200/80 bg-white shadow-sm lg:col-span-2">
          <div className="flex items-center gap-3 border-b border-neutral-100 bg-neutral-50/50 px-6 py-4">
            <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#2C315E]/10 text-[#2C315E]">
              <Headphones size={18} />
            </div>
            <div>
          ...
          <div className="border-t border-neutral-100 p-4">
            <div className="flex gap-3">
              <input
                ...
                className="h-11 flex-1 rounded-xl border border-neutral-200 bg-neutral-50/80 px-4 text-sm focus:border-[#2C315E]/40 focus:outline-none focus:ring-2 focus:ring-[#2C315E]/10"
              />
              <Button className="h-11 rounded-xl bg-[#2C315E] px-5 hover:bg-[#232752]">
                <Send size={18} />
                Send
              </Button>
            </div>
